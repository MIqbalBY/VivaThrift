...
const faqs = [
  ...
  { id: 11, category: 'pengiriman', q: 'Di mana saja lokasi COD yang disarankan?', a: 'Lokasi COD rekomendasi kami: Kantin Pusat ITS, Depan Rektorat ITS, Research Center ITS, Masjid Manarul Ilmi ITS, dan Taman Alumni ITS. Pilih area ramai dalam kampus dan sesuaikan dengan opsi meetup yang tersedia saat checkout.' },
