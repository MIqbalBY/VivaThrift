...
<template>
  ...
  >
    ...
    >
      ...
      <!-- Mobile Wishlist + Cart (auth-only) -->
      <div v-if="user" class="flex items-center gap-2">
        <NuxtLink to="/wishlist" @click="show = false" class="flex items-center gap-2 flex-1 px-3 py-2.5 rounded-lg text-sm text-gray-700 hover:bg-gray-100 transition font-medium" aria-label="Wishlist">
        ...
        <NuxtLink to="/cart" @click="show = false" class="flex items-center gap-2 flex-1 px-3 py-2.5 rounded-lg text-sm text-gray-700 hover:bg-gray-100 transition font-medium" aria-label="Keranjang">
          <svg class="w-5 h-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
